...
> This section was added by the [Claude Code Development Kit](https://github.com/drock/Claude-Code-Development-Kit) (`cdk-docs:scaffold`). It provides coding standards, workflow conventions, and MCP integration patterns for AI-assisted development.
...
### Multi-Agent Workflows & Context Management
...
- The CDK's `gemini-context-injector` hook automatically includes two key files for new sessions:
