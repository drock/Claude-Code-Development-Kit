...
# Plugin assets use CLAUDE_PLUGIN_ROOT, logs go to project directory
PLUGIN_DIR="${CLAUDE_PLUGIN_ROOT:-$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)}"
PATTERNS_FILE="$PLUGIN_DIR/config/sensitive-patterns.json"
LOG_FILE="${CLAUDE_PROJECT_DIR:-.}/.claude/logs/security-scan.log"
