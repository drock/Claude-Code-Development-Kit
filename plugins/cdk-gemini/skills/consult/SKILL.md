---
name: consult
description: Deep Gemini MCP consultation with persistent sessions for complex problem-solving
---
...
## Usage
- **With arguments**: `/consult [specific problem or question]`
- **Without arguments**: `/consult` - Intelligently infers topic from current context
